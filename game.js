...
let soundDead = new Audio("wilhem_dead.mp3")
...
let shootSound = new Audio("shootgun_shoot_1.mp3");
let chargeSound = new Audio("reload_1.mp3");

function playGif() {
  gunContainer.innerHTML = `<img src="gunGif.gif" alt="gun" class="gif_gun">`;
...
function playimg() {
  gunContainer.innerHTML = `<img src="maskgroup.png" alt="gun" class="img_gun">`;
}
...
function changeGiff(instruction, nombre) {
  if (instruction == true) {
    playerGif.innerHTML = `<img class="player"  src="player-dead.gif" alt="player" id="player_img">`;
  } else {
    playerGif.innerHTML = `<img class="player"  src="walking-player.gif" alt="player" id="player_img"><h4>${nombre}</h4>`;
  }
}